...
const initializeDataBehaviour = require('./dataLoader');

const app = express();

app.fs = fs;

app.initializeApp = function (users, todoData) {
  console.log(todoData);
  todoData = initializeDataBehaviour(todoData);
  app.todoApp = new TodoApp(todoData);
...
app.use(['/logout', '/todolists', '/todolist'], lib.redirectLoggedOutUserToLogin);
